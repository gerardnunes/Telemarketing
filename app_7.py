...
def load_data(file_data):
    try:
        if file_data.type == 'application/vnd.ms-excel' or file_data.type == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet':
...
def main():
    ...
    if data_file_1 is not None:
        ...
        if bank_raw is None:
            return  # Se o arquivo não for carregado corretamente, sai da execução
